...
## Dependencies
- **Upstream**: `ferray-core` (NdArray, Element, Dimension, broadcasting, FerrumError)
...
- [ ] AC-7: `FERRUM_FORCE_SCALAR=1 cargo test -p ferray-ufunc` passes — scalar fallback produces identical results
