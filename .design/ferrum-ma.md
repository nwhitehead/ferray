# Feature: ferrum-ma — Masked arrays for missing and invalid data
...
- REQ-12: All ferrum-ufunc elementwise operations must accept `MaskedArray` inputs and produce `MaskedArray` outputs, propagating masks correctly. Masked elements are skipped (not computed).
