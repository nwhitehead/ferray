# Feature: ferrum-core — N-dimensional array type and foundational primitives
...
### Constants
- REQ-33: Provide mathematical constants in `ferrum_core::constants`: `PI`, `E`, `INF`, `NEG_INF`, `NAN`, `EULER_GAMMA`, `PZERO` (+0.0), `NZERO` (-0.0). Also provide `NEWAXIS` as an alias for `None` in indexing contexts (expand_dims sentinel).
