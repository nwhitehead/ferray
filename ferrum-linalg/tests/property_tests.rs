// Property-based tests for ferrum-linalg
//
...
use ferrum_linalg::decomp::{QrMode, qr, svd};
use ferrum_linalg::norms::{NormOrder, det, norm, trace};
use ferrum_linalg::products::dot;
use ferrum_linalg::solve::{inv, solve};
