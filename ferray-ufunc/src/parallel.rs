// ferray-ufunc: Rayon parallel dispatch (REQ-21, REQ-22)
//
// Large arrays are parallelized via a ferray-owned Rayon ThreadPool.
...
/// The ferray-owned Rayon thread pool, lazily initialized.
static POOL: OnceLock<ThreadPool> = OnceLock::new();

/// Get or create the ferray thread pool.
...
/// Run a closure on the ferray thread pool if the element count exceeds the
