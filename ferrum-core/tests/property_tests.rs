...
use ferrum_core::manipulation::{flatten, reshape, transpose};
...
proptest! {
    ...
    fn prop_slice_returns_correct_count(
        ...
        let view = a.slice_axis(ferrum_core::Axis(0), spec).unwrap();
