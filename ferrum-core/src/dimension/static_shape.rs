// ferrum-core: Compile-time static shape types (Phase 4)
//
...
/// # Examples
/// ```
/// # use ferrum_core::dimension::static_shape::Shape1;
...
/// # Examples
/// ```
/// # use ferrum_core::dimension::static_shape::Shape2;
/// # use ferrum_core::dimension::Dimension;
...
/// # Examples
/// ```
/// # use ferrum_core::dimension::static_shape::Shape3;
/// # use ferrum_core::dimension::Dimension;
...
/// # Examples
/// ```
/// # use ferrum_core::dimension::static_shape::{Shape2, StaticMatMul};
...
impl<T: Element, D: Dimension + StaticSize> Array<T, D> {
    ...
    /// # Examples
    /// ```
    /// # use ferrum_core::dimension::static_shape::{Shape1, Shape2};
    /// # use ferrum_core::array::owned::Array;
...
mod tests {
    ...
    ///
    /// ```compile_fail
    /// use ferrum_core::dimension::static_shape::{Shape2, StaticBroadcast};
    ///
